...
#ifndef DX_SCREEN_CAPTURE_H
#define DX_SCREEN_CAPTURE_H
...
class DXScreenCapture : public ScreenCapture
{
public:
	DXScreenCapture();
	virtual ~DXScreenCapture();
	DXScreenCapture &operator=(const DXScreenCapture &) = delete;
	DXScreenCapture(const DXScreenCapture &) = delete;
